...
lexer_test_OBJS=$(OBJ_DIR)/lexer.o $(OBJ_DIR)/typechecker.o $(OBJ_DIR)/type.o $(OBJ_DIR)/environment.o
parser_test_OBJS=$(OBJ_DIR)/parser.o $(OBJ_DIR)/lexer.o $(OBJ_DIR)/type.o $(OBJ_DIR)/environment.o $(OBJ_DIR)/typechecker.o $(OBJ_DIR)/type.o
environment_test_OBJS=$(OBJ_DIR)/type.o $(OBJ_DIR)/environment.o $(OBJ_DIR)/typechecker.o $(OBJ_DIR)/type.o
